...
Public Class Form2
    ...
    Dim timwriter As New System.IO.StreamWriter("C:\Users\Timothy\Desktop\timdata.txt", True)
    ...
    Sub nextCondition()
        ...
        Else
            ...
            timwriter.WriteLine(participantid & ";" & "2" & ";" & counterbalance & ";" & score50 & ";" & score75 & ";" & score100)
            timwriter.Close()
            Thankyouscreen.Show()
            Me.Hide()
            'to here
    ...
    Sub arrowSize(ByVal cond As Integer)
        Select Case cond 'set arrow positions before task
            Case 3
                uparrow.Location = New Point(396, -23)
                downarrow.Location = New Point(396, 421)
                leftarrow.Location = New Point(-36, 199)
                rightarrow.Location = New Point(816, 200)
            Case 2
                uparrow.Location = New Point(396, 43)
                downarrow.Location = New Point(396, 355)
                leftarrow.Location = New Point(84, 199)
                rightarrow.Location = New Point(697, 200)
            Case 1
                uparrow.Location = New Point(396, 111)
                downarrow.Location = New Point(396, 288)
                leftarrow.Location = New Point(203, 199)
                rightarrow.Location = New Point(577, 200)
        End Select
    End Sub
